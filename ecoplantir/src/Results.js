...
export default class Results extends Component{
  ...
  changeFilterDisplay(event) {
    ...
    if (display === "none") {
      ...
      this.setState({filter: "Close Menu"});
    } else {
  ...
  render() {
    ...
    return(
      <div class="results-background">
        ...
        <button id="button" onClick={this.changeFilterDisplay}>{this.state.filter}</button>
        <div id="filters" class="filter-menu" display="none">
          <div>
            Care Difficulty&nbsp;&nbsp;
            <select>
              <option>Any</option>
